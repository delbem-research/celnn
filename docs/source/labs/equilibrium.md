...
The current public {ref}`SimulationResult <api-simulation-result>` can be
inspected separately. This observation is versioned library behavior; it is
deliberately not the oracle for the mathematical claim above.
